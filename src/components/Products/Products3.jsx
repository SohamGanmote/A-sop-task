...
const Products3 = () => {
			...
			content: (
				<>
					<div className="p-4 w-[530px] h-[450px]">
						<p className="suisse">Sun Care and SPF</p>
						<h1 className="py-4 text-[2.2rem]">
							Pair time in the sun with intelligent care
						</h1>
						<p className="suisse">
							Daily protection from damaging UVA and UVB sun rays is key to
							sustaining healthy, supple skin. In addition to protection, Aesop
							SPF formulations deliver hydration and skin-softening nourishment
						</p>
	...
	return (
		<div className="sm:px-[100px] mb-4 selection:bg-none x-[10px]">
			<HorizontalScrollCards cardData={cardData} id="scrollable3" />
		</div>
	);
};
